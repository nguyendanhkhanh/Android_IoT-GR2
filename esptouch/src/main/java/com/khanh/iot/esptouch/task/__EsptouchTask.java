package com.khanh.iot.esptouch.task;
...
import com.khanh.iot.esptouch.EsptouchResult;
import com.khanh.iot.esptouch.IEsptouchListener;
import com.khanh.iot.esptouch.IEsptouchResult;
import com.khanh.iot.esptouch.IEsptouchTask;
import com.khanh.iot.esptouch.protocol.EsptouchGenerator;
import com.khanh.iot.esptouch.protocol.TouchData;
import com.khanh.iot.esptouch.security.ITouchEncryptor;
import com.khanh.iot.esptouch.udp.UDPSocketClient;
import com.khanh.iot.esptouch.udp.UDPSocketServer;
...
public class __EsptouchTask implements __IEsptouchTask {
    ...
    public __EsptouchTask(Context context, TouchData apSsid, TouchData apBssid, TouchData apPassword,
                          ITouchEncryptor encryptor, EsptouchTaskParameter parameter) {
        ...
        mParameter = (IEsptouchTaskParameter) parameter;
    ...
    private void __putEsptouchResult(boolean isSuc, String bssid, InetAddress inetAddress) {
        synchronized (mEsptouchResultList) {
            ...
            if (!isExist) {
                ...
                final IEsptouchResult esptouchResult = (IEsptouchResult) new EsptouchResult(isSuc,
                        bssid, inetAddress);
    ...
    private List<IEsptouchResult> __getEsptouchResultList() {
        synchronized (mEsptouchResultList) {
            if (mEsptouchResultList.isEmpty()) {
                ...
                mEsptouchResultList.add((IEsptouchResult) esptouchResultFail);
            }
